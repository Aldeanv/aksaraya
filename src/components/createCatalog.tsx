...
export default function CreateCatalog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.cover) {
      setMessage({ text: "Cover buku wajib diunggah.", type: "error" });
      return;
    }
    ...
    try {
      ...
      setMessage({ text: "Katalog berhasil ditambahkan!", type: "success" });
      setTimeout(() => onSuccess(), 1200);
    } catch (err) {
      console.error(err);

      let errorMessage = "Terjadi kesalahan saat menambahkan katalog.";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col gap-3">
                    <label className="cursor-pointer flex flex-col items-center justify-center px-4 py-8 border-2 border-dashed border-orange-200 rounded-xl hover:border-orange-300 bg-orange-50 transition-colors">
                      ...
                      <span className="text-sm text-orange-600 font-medium">
                        {form.cover ? form.cover.name : "Pilih gambar cover"}
                      </span>
                    ...
                    {form.cover && (
                      <div className="mt-2 flex flex-col items-center">
                        ...
                        <img
                          ...
                          alt="Preview cover"
                          className="h-32 border border-orange-200 rounded-lg object-contain shadow-sm"
                        />
                      </div>
                    )}
                  </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className="w-full px-4 py-3 border border-orange-200 rounded-xl focus:ring-2 focus:ring-orange-300 focus:border-orange-300 bg-white"
